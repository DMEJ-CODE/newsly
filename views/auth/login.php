...
<div class="container-fluid min-vh-100 d-flex align-items-center justify-content-center bg-light py-5">
    ...
    <a href="<?= BASE_URL ?>"
        class="position-absolute top-0 start-0 m-4 btn btn-outline-pill bg-white shadow-sm text-decoration-none px-4 py-2 z-3">
    ...
    <div class="auth-card w-100 shadow-lg" style="max-width: 480px; transition: all 0.4s ease-wrap;">
        <div class="p-4 p-md-5">
            ...
            <div class="text-center mb-5">
                ...
                <h1 class="fw-extrabold mb-2" style="font-size: clamp(1.8rem, 4vw, 2.2rem);">Welcome back</h1>
                <p class="text-muted fw-medium small">Continue your premium reading experience.</p>
            </div>
            ...
            <form action="<?= BASE_URL ?>auth/login" method="POST" id="loginForm">
                <div class="mb-4">
                    ...
                    <input type="email" class="form-control form-control-custom w-100" id="email" name="email"
                ...
                <div class="mb-5 position-relative">
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <label for="password"
                            class="form-label small fw-bold text-uppercase text-muted mb-0">Password</label>
                        <a href="<?= BASE_URL ?>auth/forgot"
                            class="text-primary-custom small fw-bold text-decoration-none">Forgot?</a>
                    </div>
                    <div class="position-relative">
                        <input type="password" class="form-control form-control-custom w-100 pe-5" id="password"
                            name="password" placeholder="••••••••••••••••" required>
                        <button type="button"
                            class="btn btn-link position-absolute end-0 top-50 translate-middle-y border-0 text-muted p-0 me-3"
                            id="togglePassword">
                ...
                <div class="d-flex justify-content-between gap-3 mb-5">
                    <button type="button"
                        class="btn btn-outline-pill flex-grow-1 fw-medium d-flex align-items-center justify-content-center gap-2 py-2">
                ...
                <div class="text-center pt-4 border-top">
                    <p class="text-muted small fw-medium mb-0">
                        Don't have an account? <a href="<?= BASE_URL ?>auth/register"
                            class="text-primary-custom fw-bold text-decoration-none ms-1">Create one free</a>
                    </p>
                </div>
            </form>
        </div>
